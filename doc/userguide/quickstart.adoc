...
image::pictures/dataset_two_clusters.png[scaledwidth=45.0%]
...
image::pictures/simple_single_layer_perceptron.png[scaledwidth=45.0%]
...
image::pictures/optimization-step_loss.png[scaledwidth=50.0%]
