...
class BarzilaiBorweinGradientDescent(GradientDescent):
    ...
    """
    def __init__(self, learning_rate, use_locking=False, name='BarzilaiBorweinGradientDescent'):
        ...
        """
        super(BarzilaiBorweinGradientDescent, self).__init__(learning_rate, use_locking, name)
